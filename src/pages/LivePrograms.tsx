...
const livePrograms = [
  {
    ...
    href: "/200k-method",
    youllWorkOn: [
      "Strategic Benchmark & leadership baseline calibration",
      "Gap Mapping: Skill, scope & positioning misalignment",
      "Executive Positioning (resume, LinkedIn & narrative rebuild)",
      "Leadership Signal & visibility strategy",
      "Interview authority & scope-level articulation",
      "Compensation positioning & negotiation strategy",
    ],
    includes: [
      "Weekly live strategic coaching sessions",
      "Real-time resume & LinkedIn asset reviews",
      "Accountability triads for implementation",
      "Role-play simulations (interviews & executive conversations)",
      "Private high-performance community",
    ],
    featured: true,
    ctaText: "Start My Strategic Elevation",
  },
];
